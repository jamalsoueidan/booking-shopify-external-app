...
router.post("/notifications/:id", check("id").notEmpty(), handleController(controller.resend));

router.delete("/notifications/:id", check("id").notEmpty(), handleController(controller.cancel));
