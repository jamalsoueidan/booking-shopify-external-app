...
import { HelperArray, usePosition, useTag, useTranslation } from "@jamalsoueidan/pkg.frontend";
import { Avatar, Button, ResourceItem, ResourceList, Text } from "@shopify/polaris";
...
export const StaffList = ({ action }: StaffListProps) => {
  ...
  const items = useMemo(() => [...value].sort(HelperArray.sortByText((d) => d.fullname)), [value]);
